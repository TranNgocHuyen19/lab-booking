...
import { ChevronLeft, Loader2, Save, Search, Check, Users, UserPlus, Info, HelpCircle } from 'lucide-react'
...
const LecturerAddResearchGroupPage = () => {
  ...
  const onSubmit = async (data: CreateResearchGroupRequest) => {
    try {
      ...
      navigate(PATHS.LECTURER.RESEARCH_GROUPS)
    } catch (error) {
          ...
          <form className='space-y-8 pb-10'>
            <div className='grid grid-cols-1 lg:grid-cols-3 gap-8'>
              ...
              <div className='space-y-6'>
                <div className='bg-white rounded-2xl shadow-xl border border-gray-100 flex flex-col h-full min-h-[600px] animate-fade-in'>
                              ...
                              {users.map((user) => {
                                ...
                                return (
                                  <div
                                    ...
                                    className={cn(
                                      'flex items-center justify-between p-3  cursor-pointer transition-all border border-transparent mb-1',
            ...
            <div className='flex items-center justify-end gap-3 border-t border-gray-100'>
              <Button
                ...
                variant='outline'
                onClick={() => navigate(-1)}
                className='h-12 px-8 font-bold border-gray-200  hover:bg-gray-50 transition-all'
              >
                Hủy bỏ
              </Button>
              <Button
...
export default LecturerAddResearchGroupPage
