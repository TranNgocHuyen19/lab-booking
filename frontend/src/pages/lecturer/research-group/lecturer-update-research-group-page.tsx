...
import { ChevronLeft, Loader2, Info, Users, Save, Search, HelpCircle, Check, UserPlus } from 'lucide-react'
...
import { useLecturerResearchGroupDetailQuery, useUpdateResearchGroupMutation } from '@/queries/research-group.queries'
...
const LecturerUpdateResearchGroupPage = () => {
  const { id } = useParams()
  const navigate = useNavigate()
  const groupId = Number(id)

  const { data: detailData, isLoading: isLoadingDetail } = useLecturerResearchGroupDetailQuery(groupId)
...
export default LecturerUpdateResearchGroupPage
