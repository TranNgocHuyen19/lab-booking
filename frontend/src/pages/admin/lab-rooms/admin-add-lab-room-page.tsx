...
import { useCreateLabRoomMutation } from '@/queries/lab-room.queries'
...
const AdminAddLabRoomPage = () => {
  const navigate = useNavigate()
  const createMutation = useCreateLabRoomMutation()
  ...
  const onSubmit = async (data: LabRoomRequest) => {
    try {
      ...
      toast.success('Thêm phòng thực hành thành công')
        ...
        <div className='mb-8 flex flex-col md:flex-row md:items-end justify-between gap-6'>
          <div className='flex items-start gap-4'>
            ...
            <div className='flex flex-col gap-1'>
              ...
              <p className='text-gray-500 font-medium'>Thiết lập thông tin cho phòng thực hành mới</p>
            </div>
          </div>
        </div>
          ...
          <form className='space-y-8 pb-10'>
            <div className='grid grid-cols-1 lg:grid-cols-2 gap-8'>
              ...
              <div className='space-y-6 lg:col-span-1 h-fit sticky top-6'>
                <div className='bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden animate-fade-in h-full'>
                  <div className='p-6 border-b border-gray-100 bg-gray-50/30 flex items-center gap-3'>
                    <div className='h-10 w-10 bg-primary/10 flex items-center justify-center rounded-xl'>
...
export default AdminAddLabRoomPage
